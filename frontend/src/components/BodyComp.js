        ...
        <div className="container">
          <div className="about-us">
            <div className="about-1 mt-5 ">
              <p className="elb text-center">Find out How we Help Students</p>
              <p className="text-center narrative">
                ...
                <br /> factor in helping them show what their best actually is.{" "}
              </p>
            </div>
        ...
        <div className="container py-3 pl-4 pr-4">
          ...
          <div>
            <p className="text-center mt-5">
              ...
              diagnose and treat yourem ipsu raol ad
              <br /> meniam, quis nostrud exercitation. We doctor appointments
              have te diagnose and treat yourem ipsu r<br /> exercitation docts
              and have the diagnose
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="bg">
                <div className="qualities-1">
                  ...
                  <div className="  d-flex calendar-1 ">
                    ...
                    <div className="pl-3"> 28th April 2021</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container ">
          <div className="inner">
            <div className="comp">
              ...
              <p className="comp-2">
                Replenish his third creature and meet
                <br /> blessed void a fruit gathered you're,
                <br /> they're two waters own morning gathered greater.
              </p>
            </div>
            <div className="cover">
